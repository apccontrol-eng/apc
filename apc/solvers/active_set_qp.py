...
def active_set_qp(H, f, G, b, x0=None, tol=1e-10, max_iter=100):
    ...
    # =========================================================================
    # initial active set, working set
    ...
    for iteration in range(max_iter):
        ...
        if np.linalg.norm(p) < tol:
            ...
            # =================================================================
            # checking if optimality is satisfied
            if min_lambda >= -tol:
                break
            
            # =================================================================
            # removing most negative multiplier constraint
            ...
            for i in range(m):
                ...
                denom = Gi @ p
                # =============================================================
                # checking whether constraint becomes active
                if denom > tol:
    ...
    # =========================================================================
    # building full multiplier vector
